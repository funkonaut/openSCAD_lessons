...
//Declare a variable h2 and set it equal to half of your h variable

//First make a centered cylinder that is half the height and twice the width of the cube and then place the cylinder so that it is on top of the cube (hint remember where translation commands go)
